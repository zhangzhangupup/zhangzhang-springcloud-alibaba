...
import com.zhang.constant.AuthorityConstant;
import com.zhang.constant.CommonConstant;
import com.zhang.mapper.EcommerceUserMapper;
import com.zhang.pojo.EcommerceUser;
import com.zhang.result.LoginUserInfo;
import com.zhang.result.UsernameAndPassword;
import com.zhang.service.IJWTService;
...
public class JWTServiceImpl implements IJWTService {
    ...
    public String generateToken(String username, String password, int expire)
        ...
        EcommerceUser ecommerceUser = ecommerceUserMapper.findByUsernameAndPassword(
                username, password
        );
    ...
    public String registerUserAndGenerateToken(UsernameAndPassword usernameAndPassword)
        ...
        EcommerceUser oldUser = ecommerceUserMapper.findByUsername(
        ...
        // 注册一个新用户, 写一条记录到数据表中
        int insert = ecommerceUserMapper.save(ecommerceUser.getUsername(), ecommerceUser.getPassword(), ecommerceUser.getExtraInfo());
        log.info("register user success: [{}], [{}],[{}]", ecommerceUser.getUsername(),
                ecommerceUser.getId(), insert);
